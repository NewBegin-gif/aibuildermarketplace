#!/usr/bin/env python3
"""Voegt 2 NIEUWE affiliates toe aan de ARTIKELGENERATOR (=> ook in /b2b/ filter + reviews):
Softr, MarketerHire. (Batch 12 juni 2026 — b)
...
NEW = {
    "Softr": {
        "url": "https://get.softr.io/39gkvjscbtyc",
        "domain": "softr.io", "category": "No-code", "color": "#5E5CE6",
        "icon": "🧩", "letter": "S", "badge": "Free plan", "price": "From $59/mo",
        "rating": "4.7", "reviews": "400",
        "tagline": "Build AI business apps, portals & internal tools without code",
        "competitors": ["Glide","Bubble","Stacker","Noloco","Retool","Airtable Interfaces"],
        "topics": ["no-code-app-builder","client-portal-software","internal-tools-builder",
            "airtable-frontend","glide-alternative","bubble-alternative","stacker-alternative",
            "membership-site-builder","no-code-crm-builder","business-app-builder"],
    },
    "MarketerHire": {
        "url": "https://try.marketerhire.com/ybfi0nx3i7r7",
        "domain": "marketerhire.com", "category": "Marketing Talent", "color": "#111827",
        "icon": "🎯", "letter": "M", "badge": "Matching", "price": "Custom",
        "rating": "4.6", "reviews": "300",
        "tagline": "Hire pre-vetted expert marketing talent on demand, matched in days",
        "competitors": ["Toptal","Upwork","Growth Collective","Mayple","Fiverr Pro","Paro"],
        "topics": ["hire-freelance-marketer","fractional-cmo-service","marketing-talent-marketplace",
            "toptal-alternative","growth-marketer-on-demand","paid-ads-specialist-hire",
            "email-marketing-freelancer","mayple-alternative","marketing-agency-alternative"],
    },
}
