#!/usr/bin/env python3
"""Voegt 1 NIEUWE affiliate toe aan de ARTIKELGENERATOR (=> ook in /b2b/ filter + reviews):
Dify. (Batch 12 juni 2026 — c)
...
NEW = {
    "Dify": {
        "url": "https://affiliate.dify.ai/6g7z70ov0bx6",
        "domain": "dify.ai", "category": "AI Development", "color": "#1C64F2",
        "icon": "🧠", "letter": "D", "badge": "Free plan", "price": "From $59/mo",
        "rating": "4.6", "reviews": "500",
        "tagline": "Open-source platform for building agentic AI workflows & LLM apps",
        "competitors": ["LangChain","Flowise","n8n","Make","Lindy.ai","Stack AI"],
        "topics": ["agentic-workflow-builder","llm-app-platform","open-source-ai-builder",
            "rag-pipeline-software","langchain-alternative","flowise-alternative",
            "no-code-ai-agent-builder","ai-workflow-automation","build-ai-chatbot-platform"],
    },
}
